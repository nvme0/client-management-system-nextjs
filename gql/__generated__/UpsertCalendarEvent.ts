...
export interface UpsertCalendarEvent_upsertCalendarEvent_client_installments {
  amount: string;
  currency: string;
  date: GqlDateTime;
  notes: string | null;
...
export interface UpsertCalendarEvent_upsertCalendarEvent_client {
  ...
  address: string | null;
  notes: string | null;
  installments: UpsertCalendarEvent_upsertCalendarEvent_client_installments[] | null;
